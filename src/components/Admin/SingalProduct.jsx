...
import Ratin from '../partials/Ratin';
      ...
      <div className="container py-5">
          ...
          <div className="row">
            <div className="col-md-6">
              <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" className="flexslider nav-inside control-nav-dark">
                  <img  style={{width:'100%', height:'100%'}} src={product.pro_link} alt="" />
                  <img src="" alt="" />
              </div>
            </div>
              ...
              <div className="single-product-price">
                <div className="row">
                  <div className="col-xs-6">
                    {
                      product.sale_price ?
                      <> <h3 ><del style={{color:'#9b1c31'}}>{product.regular_price} Tk</del> <span>{ product.sale_price }</span>Tk</h3></>
                      :<h3><span>${product.regular_price}</span></h3>
                    }
                    
                  </div>
                  <div className="col-xs-6 text-right">
                   <Ratin rate={product.rating} />
                  </div>
                </div>
              </div>
              ...
              <div className="single-product-add">
                <form action="https://" className="inline-form">
                  <div className="input-group">
                    <input type="number" placeholder="QTY" value="1" min="1" className="form-control" />
                      <div className="button-div">
                      <span className="input-group-btn">
                      <button type="button" className="btn btn-danger">Add to Cart<i className="ti-bag"></i></button></span>
                      </div>
                  </div>
                </form>
              </div>
        ...
        <div className="product-tabs">
          <ul role="tablist" className="nav nav-tabs">
            <li role="presentation" className="active"><a href="https://first-tab" role="tab" data-toggle="tab">Description</a>
            </li>
          ...
          <div className="row">
                ...
                <div className="shop-product">
                  ...
                  <div className="product-info">
                    <h4 className="upper"><a href="https://">{}</a></h4><span> BDT</span>
                    <div className="save-product"><a href="https://"><i className="icon-heart"></i></a>
                    </div>
                  </div>
                </div>
              </div>
